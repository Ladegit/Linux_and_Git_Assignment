...
with DAG(
    dag_id= "CoreSentiment",  #The name of the DAG
    ...
    # downloading 11pm pageviews data for 10th of October, 2024
    
    def _download_zipped_file(url, save_path):
        url = 'https://dumps.wikimedia.org/other/pageviews/2024/2024-10/pageviews-20241010-230000.gz'
        save_path = '/opt//workspaces/airflow/dags/CoreSentiments/LandingPath.zip'       
    ...
    extract_zip_files = BashOperator(
        ...
        bash_command= '/opt//workspaces/airflow/dags/CoreSentiments/LandingPath.zip -d /opt/workspaces/airflow/dags/CoreSentiments/Extracted_files' 
    )
